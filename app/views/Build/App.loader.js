					...
					if (
						...
						for (var o in r) {
							...
							if (c.frameworkUrl.endsWith("." + a[0])) {
								var s =
									"Unable to parse " + c.frameworkUrl + "!";
	...
	return (
		(c.SystemInfo = (function() {
			...
			(o = f[o] || o),
				...
				a &&
					...
					(glVersion = gl ? 2 : 0),
					gl ||
						((gl = a && a.getContext("webgl")) && (glVersion = 1)),
					gl &&
						(s =
		...
		(c.XMLHttpRequest = (function() {
			...
			function n() {
				...
				function t() {
					...
					(e.onupgradeneeded = function(e) {
						...
						r.objectStoreNames.contains(d.name) ||
							r.createObjectStore(d.name);
					}),
			...
			(a.prototype.send = function(r) {
				...
				return (
					(o.enabled =
						o.enabled && "arraybuffer" == n.responseType && !r),
					o.enabled
						? void l.execute(
								i.name,
								"get",
